    ...
    useEffect(()=>{
      ...
      moviedata.forEach((movie)=>{
       ...
       if(movie.title===clickedmovie.moviename){
          ...
          artistname=movie.artists[0].first_name+" "+movie.artists[0].last_name;
  ...
  return (
    ...
    <div>
     ...
     <Link className="btn btn-primary homelink" to="/">
      <ArrowBackIosIcon></ArrowBackIosIcon><span >Back to Home</span>
    </Link>
    ...
    <Typography style={{marginTop:"16px"}} variant='h5'>
      <b>Plot</b>:<a href={moviedata.wiki_url}>(wiki_link)</a> {moviedata.storyline}
    </Typography>
    <Typography style={{marginTop:"16px"}} variant='h5'>
      <b>Trailer</b>:
      <div>
